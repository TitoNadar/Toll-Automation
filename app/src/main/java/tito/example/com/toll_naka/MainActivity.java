...
import tito.example.com.toll_naka.ViewHolder.TollViewHolder;
...
public class MainActivity extends FragmentActivity
   ...
   FirebaseRecyclerAdapter<Tolls,TollViewHolder> firebaseRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("City");

        //Init recylerview
        recyclerView=(RecyclerView)findViewById(R.id.rtl);
